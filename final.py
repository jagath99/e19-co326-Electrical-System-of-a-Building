...
if __name__ == "__main__":
    ...
    while True:
        ...
        avg_power = voltage_rms * current_rms
        ...
        print(f"Voltage RMS: {voltage_rms:.2f} V")
        print(f"Current RMS: {current_rms:.2f} A")
        print(f"Average Power: {avg_power:.2f} W")
        print(f"Power Meter Data: Active Power: {active_power:.2f} W, Reactive Power: {reactive_power:.2f} VAR, Apparent Power: {apparent_power:.2f} VA")
    
        # Prepare data payloads
        voltage_data = {
            "timestamp": timestamp,
            "voltage_rms": voltage_rms,
            "resistance": mean_R  # Example value, real implementation would vary
        }
        ...
        # Save data to files
        with open('voltage_data.json', 'w') as f:
